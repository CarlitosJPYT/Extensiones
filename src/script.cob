...
003100     DISPLAY "EL VALOR PRINCIPAL ES (0.1 A 999999999.99)".
003200     ACCEPT ENTRADA.
003300     MOVE ENTRADA TO PRINCIPAL.
003400     IF PRINCIPAL < 0.1 OR PRINCIPAL > 999999999.9 THEN
...
004800     DISPLAY "NUMEROS DE PERIODOS (1 HASTA 12)".
004900     ACCEPT ENTRADA.
005000     MOVE ENTRADA TO NPERIODOS.
005100     IF NPERIODOS < 1 OR NPERIODOS > 12 THEN
...
006500 NUEVO.
006600     DISPLAY "VA DE NUEVO (S/N)."
006700     ACCEPT OPC.
